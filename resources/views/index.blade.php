    ...
    <main>
        ...
        <div class="container mw-1620 bg-white border-radius-10">
                                ...
                                <div class="swiper-slide">
                                    <a href="{{ route('shop.index', ['category' => $category->slug]) }}"
                                        ...
                                        <img loading="lazy" class="w-100 h-auto mb-3"
                                            ...
                                            height="124" alt="{{ $category->name }}" title="{{ $category->name }}" />
            ...
            <section class="hot-deals container">
                <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4 text-capitalize">Sản phẩm giảm giá</h2>
                <div class="row">
                    <div
                        class="col-md-6 col-lg-4 col-xl-20per d-flex align-items-center flex-column justify-content-center py-4 align-items-md-start">
                        <h2>Sale</h2>
                        <h2 class="fw-bold">Giảm giá tới 40%</h2>
            ...
            <section class="products-grid container">
                <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4 text-capitalize">Sản phẩm nổi bật</h2>
