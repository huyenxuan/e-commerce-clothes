                                ...
                                <ul class="list list-inline mb-0 category-list">
                                    @foreach ($categories as $category)
                                        <li class="list-item d-flex align-items-center justify-content-between">
                                            <span class="d-flex align-items-center menu-link py-1">
                                                ...
                                                <label for="category-{{ $category->id }}"
                                                    class="chk-label">{{ $category->name }}</label>
                                            </span>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="10" data-slider-max="500" data-slider-step="5"
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 px-1 order-1 order-md-0"
                            ...
                            <option value="4" {{ $order == 4 ? 'selected' : '' }}>Thấp đến cao</option>
                        </select>
